...
- Custom processors
 ...
 Refer to by [Data Health As Service](https://github.com/mgorav/data-health-service). In the project, I am simulating Data Health Event and interpreting them live:
